import { GitBranch, Key, Cpu } from 'lucide-react';
...
const TAB_CONFIG: MainTabConfig[] = [
  ...
  { id: 'claude', labelKey: 'Claude Driver', icon: Cpu },
        ...
        {TAB_CONFIG.map((tab) => {
          ...
          return (
            <button
              ...
              className={`border-b-2 px-4 py-3 text-sm font-medium transition-colors ${isActive
